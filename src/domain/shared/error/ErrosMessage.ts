export const ErrosMessage = {
  ...
  ITEMS_WITH_QUANTITY_ZERO: "Items with quantity zero",
  ...
  ERROR_WHILE_PLACING_ORDER:"An error occurred while placing the order.",
  CUSTOMER_NOT_INFORMATION:"Customer information is required.",
